...
summary: "Ongoing repairs and maintainance relating to my Roland SH-101 monosynth."
...
Armed with the service manual - [here](https://notebook.zoeblade.com/Downloads/Documentation/Roland/SH-101_service_notes.pdf) was the best copy I could find, which I'm mirrorring [here](/files/SH-101_service_notes.pdf) for future posterity, just in case - I took to the task of working out where the issue lay.
...
The original Novamod instruction document used to be pretty easy to find online, but many of the links are dead now. [This](https://www.scribd.com/document/289423340/Roland-Sh-101-Nova-Mod) is the best online source I could find.

For posterity, I've uploaded my copy to the site. Download [here](/files/ROLAND_SH-101_NOVAMOD.pdf).
